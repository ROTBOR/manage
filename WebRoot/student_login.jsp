...
<body>
	<div class='login'>
	  ...
	  <form action="${pageContext.request.contextPath }/Student_Login.do" method="post">
	  <div class='login_fields'>
	    <div class='login_fields__user'>
	      <div class='icon'>
	        <img alt="" src='img/user_icon_copy.png'></img>
	      </div>
	      <input name="sno" placeholder='用户名' maxlength="16" type='text'/>
	    </div>
	    <div class='login_fields__password'>
	      <div class='icon'>
	        <img alt="" src='img/lock_icon_copy.png'></img>
	      </div>
	      <input type="password" name="userid"  placeholder='密码' maxlength="16" type='text' />
	    </div>
