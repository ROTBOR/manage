...
<table border="0" cellspacing="0" cellpadding="0" class="dataTable">
  <thead>
    <tr>
	  ...
	  <th class="dataTableHeader">平时成绩</th>
	  <th class="dataTableHeader">期末成绩</th>
	  <th class="dataTableHeader">总成绩</th>
	  <th class="dataTableHeader">修改成绩</th>
    </tr>
  </thead>
  <tbody>
  <c:forEach items="${list}" var="score">
   ...
   <td>${score.grade}</td> 
   <td><a href="${pageContext.request.contextPath }/findScore.do?sno=${score.sno}&&cou_classno=${score.cou_classno}">点击修改成绩</a></td>
    </tr>
  </c:forEach>
  </tbody>
</table>
